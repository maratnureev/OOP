...
SCENARIO("Valid url with document by params")
{
	std::string url = "http://www.mysite.com/docs/document1.html?page=30&lang=en#title";
	REQUIRE_NOTHROW(CHttpURL("www.mysite.com", "/docs/document1.html?page=30&lang=en#title", Protocol::HTTP));
	CHttpURL httpUrl("www.mysite.com", "/docs/document1.html?page=30&lang=en#title", Protocol::HTTP);
